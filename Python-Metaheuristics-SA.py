...
sa = simulated_annealing(min_values = [-5,-5], max_values = [5,5], mu = 0, sigma = 0.01, initial_temperature = 1.0, temperature_iterations = 1000, final_temperature = 0.0001, alpha = 0.9)
